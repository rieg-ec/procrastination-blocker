...
5. Add **Get Item from List**, choose **First Item**, and use the Dates from the
   previous action.
6. Add **Set Focus** and configure it as **Turn Work On until Time**. Use the
   First Item date from the previous action as the time.
...
-> Set Focus: Work, On, until Time [First Item]
-> Text: success
-> Stop and Output
```
...
until the generated date. Turn it off manually after testing if needed.
